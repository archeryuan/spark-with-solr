...
public class TopChangelInstagramFilter implements Function<Tuple2<Long, NewTopChannel>, Boolean>, Serializable {

	private static final long serialVersionUID = -3778479205840134893L;

	@Override
	public Boolean call(Tuple2<Long, NewTopChannel> tuple) {
		return tuple._2.getMedia().startsWith("Instagram");
	}
}
