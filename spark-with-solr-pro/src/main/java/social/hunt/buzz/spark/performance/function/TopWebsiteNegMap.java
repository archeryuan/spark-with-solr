...
public class TopWebsiteNegMap implements PairFunction<Tuple2<String, TopWebsiteEntity>, Long, TopWebsiteEntity>, Serializable {
	...
	public Tuple2<Long, TopWebsiteEntity> call(Tuple2<String, TopWebsiteEntity> tuple) {
		return new Tuple2<Long, TopWebsiteEntity>(tuple._2.getEngageNeg(), tuple._2);
	}
}
